...
| Дата и время создания | Дата, когда был создан заказ | Дата, время, ДД.ММ.ГГГГ ЧЧ:MM |  |  |
...
| Электронный адрес | Электронная почта клиента, разместившего заказ | Символьно-числовое значение | 100 | Должно содержать символ @ |
| Телефона | Телефон клиента, разместившего заказ | Числовое значение | 19 | Заполняется по формату:<br>+7(000)-00-00 |
...
| Товар | Информация о товарах в заказе | Артикул товара<br>+ Название товара<br>+ Фотография<br>+  Цена товара<br>+ Описание товара<br>+ Категория товара<br> |  |  |
...
| Номер категории | Уникальный ID категории | Числовое значение | 20 |  |
